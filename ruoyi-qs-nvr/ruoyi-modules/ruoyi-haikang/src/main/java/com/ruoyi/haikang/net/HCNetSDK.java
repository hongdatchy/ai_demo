...
//网络(NET_DVR_NETCFG_V30结构)
    ...
    public static final int NET_DVR_GET_THERMOMETRY_PRESETINFO = 3624;  //获取测温NET_DVR_GET_WORK_STATUS_V50预置点关联配置参数
...
//IPC接入参数配置
    ...
    public static class NET_DVR_FRAMEFORMAT_EX extends HIKSDKStructure {//ATM参数添加FTP上传参数, 银行定制, 2006-11-17
        public int dwSize;
        public byte[] sATMIP = new byte[16];                        /* ATM IP地址 */
        public int dwATMType;                        /* ATM类型 */
        public int dwInputMode;                        /* 输入方式	0-网络侦听 1-网络接收 2-串口直接输入 3-串口ATM命令输入*/
...
//    int NET_DVR_PlayBackByName(int lUserID, String sPlayBackFileName, HWND hWnd);
    ...
    int NET_DVR_PlayBackByTime(int lUserID, int lChannel, NET_DVR_TIME lpStartTime, NET_DVR_TIME lpStopTime, int hWnd);
...
//2007-11-30 V211支持以下接口 //11
    ...
    public static class NET_DVR_GPSALARMINFO extends HIKSDKStructure {
