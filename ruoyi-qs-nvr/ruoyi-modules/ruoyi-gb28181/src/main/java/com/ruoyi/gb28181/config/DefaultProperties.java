...
//        Logger log = LoggerFactory.getLogger(AlarmNotifyMessageHandler.class);
        if (sipLog) {
            properties.setProperty("gov.nist.javax.sip.STACK_LOGGER", "com.ruoyi.gb28181.config.StackLoggerImpl");
            properties.setProperty("gov.nist.javax.sip.SERVER_LOGGER", "com.ruoyi.gb28181.config.ServerLoggerImpl");
