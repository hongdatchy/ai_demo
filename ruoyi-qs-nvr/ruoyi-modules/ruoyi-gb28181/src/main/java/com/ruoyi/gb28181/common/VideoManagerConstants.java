...
public class VideoManagerConstants {
	...
	public static final String DEVICE_PREFIX = "QS_DEVICE_INFO";
	public static final String DEVICE_CHANNEL_PREFIX = "QS_DEVICE_CHANNEL_INFO";
	...
	public static final String SIP_CSEQ_PREFIX = "QS_SIP_CSEQ_";
	 ...
	 * 设备录像计划模板信息结果前缀
	 */
	public static final String REDIS_RECORD_PLAN_INFO_RES_PRE = "GB_RECORD_PLAN_INFO_RES_";
	/**
	 * Redis Const
	 * 设备录像计划模板信息结果前缀
	 */
	public static final String REDIS_RECORD_PLAN_INFO_RES_COUNT_PRE = "GB_RECORD_PLAN_INFO_RES_COUNT:";
