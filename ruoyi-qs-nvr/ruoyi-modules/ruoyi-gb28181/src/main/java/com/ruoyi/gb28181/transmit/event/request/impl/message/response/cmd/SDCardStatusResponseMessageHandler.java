...
@Slf4j
@Component
public class SDCardStatusResponseMessageHandler extends SIPRequestProcessorParent implements InitializingBean, IMessageHandler {
    ...
    public void handForDevice(RequestEvent evt, Device device, Element element) {
        try {
            ...
            log.error("[命令发送失败] 存储卡状态查询: {}", e.getMessage());
        }
        // 解析存储卡状态查询响应
