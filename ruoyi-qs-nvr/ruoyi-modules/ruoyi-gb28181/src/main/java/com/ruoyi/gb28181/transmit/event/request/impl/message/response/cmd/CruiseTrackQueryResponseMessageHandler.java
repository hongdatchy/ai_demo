...
@Slf4j
@Component
public class CruiseTrackQueryResponseMessageHandler extends SIPRequestProcessorParent implements InitializingBean, IMessageHandler {
    ...
    public void handForDevice(RequestEvent evt, Device device, Element element) {
        try {
            ...
            log.error("[命令发送失败] 巡航轨迹查询: {}", e.getMessage());
        }
        // 解析巡航轨迹查询响应
