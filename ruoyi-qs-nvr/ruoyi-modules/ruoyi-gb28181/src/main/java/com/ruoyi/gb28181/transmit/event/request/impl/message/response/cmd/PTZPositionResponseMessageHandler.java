...
@Slf4j
@Component
public class PTZPositionResponseMessageHandler extends SIPRequestProcessorParent implements InitializingBean, IMessageHandler {
    ...
    public void handForDevice(RequestEvent evt, Device device, Element element) {
        try {
            ...
            log.error("[命令发送失败] PTZ精准状态查询: {}", e.getMessage());
        }
        // 解析PTZ精准状态查询响应
