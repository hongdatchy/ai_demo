...
@Slf4j
@Component
public class CruiseTrackListQueryResponseMessageHandler extends SIPRequestProcessorParent implements InitializingBean, IMessageHandler {

    private final String cmdType = "CruiseTrackListQuery";
    ...
    public void handForDevice(RequestEvent evt, Device device, Element element) {
        try {
            ...
            log.error("[命令发送失败] 巡航轨迹列表查询: {}", e.getMessage());
        }
        // 解析巡航轨迹列表查询响应
        ...
        if (json.get("SumNum") != null) {
            jsonObject.put("SumNum", json.get("SumNum"));
        }
        if (json.get("CruiseTrackList") != null) {
            jsonObject.put("CruiseTrackList", json.getJSONObject("CruiseTrackList"));
        }
