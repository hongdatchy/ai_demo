...
@Slf4j
@Component
public class HomePositionQueryResponseMessageHandler extends SIPRequestProcessorParent implements InitializingBean, IMessageHandler {
    ...
    public void handForDevice(RequestEvent evt, Device device, Element element) {
        try {
            ...
            log.error("[命令发送失败] 看守位查询: {}", e.getMessage());
        }
        // 解析看守位查询响应
        ...
        if (json.get("HomePosition") != null) {
            jsonObject.put("HomePosition", json.getJSONObject("HomePosition"));
        }
